...
The data is split into **train** and **test** subdirectories, each with a set of `.txt` files, one `.txt` file for each video clip (about 90% of the clips are in **train**, and the remaining 10% in **test**).
...
Each **frame line** has the following 19 columns:
...
*Source: [https://google.github.io/realestate10k/download.html](https://google.github.io/realestate10k/download.html)*
